...
namespace StockExchangeYahooFinance.Migrations
{
    ...
    [Migration("20170512135637_earningsTrendRelatedObjectsChange")]
    partial class earningsTrendRelatedObjectsChange
    {
            ...
            modelBuilder.Entity("StockExchangeYahooFinance.Data.Models.DefaultKeyStatistics", b =>
                {
                    ...
                    b.Property<double>("AnnualHoldingsTurnover");

                    b.Property<double>("AnnualReportExpenseRatio");

                    b.Property<double>("Beta");

                    b.Property<double>("Beta3Year");
                    ...
                    b.Property<double>("EarningsQuarterlyGrowth");
                    ...
                    b.Property<double>("FiftyTwoWeekChange");

                    b.Property<double>("FiveYearAverageReturn");

                    b.Property<double>("FloatShares");

                    b.Property<double>("ForwardEps");
                    ...
                    b.Property<double>("HeldPercentInsiders");

                    b.Property<double>("HeldPercentInstitutions");

                    b.Property<double>("LastCapGain");

                    b.Property<double>("LastDividendValue");
                    ...
                    b.Property<double>("MorningStarOverallRating");

                    b.Property<double>("MorningStarRiskRating");

                    b.Property<string>("MostRecentQuarter");

                    b.Property<double>("NetIncomeToCommon");
                    ...
                    b.Property<double>("PriceToSalesTrailing12Months");

                    b.Property<double>("ProfitMargins");

                    b.Property<double>("RevenueQuarterlyGrowth");

                    b.Property<double>("SandP52WeekChange");

                    b.Property<double>("SharesOutstanding");

                    b.Property<double>("SharesShort");

                    b.Property<double>("SharesShortPriorMonth");

                    b.Property<double>("ShortPercentOfFloat");

                    b.Property<double>("ShortRatio");

                    b.Property<double>("ThreeYearAverageReturn");
            ...
            modelBuilder.Entity("StockExchangeYahooFinance.Data.Models.EarningsTrend", b =>
                {
                    ...
                    b.Property<string>("EarningsEstimateId");

                    b.Property<string>("EndDate");

                    b.Property<string>("EpsRevisionsId");

                    b.Property<string>("EpsTrendId");
                    ...
                    b.Property<string>("RevenueEstimateId");

                    b.HasKey("Id");

                    b.HasIndex("CompaniesId");

                    b.HasIndex("EarningsEstimateId");

                    b.HasIndex("EpsRevisionsId");

                    b.HasIndex("EpsTrendId");

                    b.HasIndex("RevenueEstimateId");
            ...
            modelBuilder.Entity("StockExchangeYahooFinance.Data.Models.EarningsTrend", b =>
                {
                    ...
                    b.HasOne("StockExchangeYahooFinance.Data.Models.EarningsEstimate", "EarningsEstimate")
                        .WithMany()
                        .HasForeignKey("EarningsEstimateId");

                    b.HasOne("StockExchangeYahooFinance.Data.Models.EpsRevisions", "EpsRevisions")
                        .WithMany()
                        .HasForeignKey("EpsRevisionsId");

                    b.HasOne("StockExchangeYahooFinance.Data.Models.EpsTrend", "EpsTrend")
                        .WithMany()
                        .HasForeignKey("EpsTrendId");

                    b.HasOne("StockExchangeYahooFinance.Data.Models.RevenueEstimate", "RevenueEstimate")
                        .WithMany()
                        .HasForeignKey("RevenueEstimateId");
                });
